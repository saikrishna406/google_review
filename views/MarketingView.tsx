...
const MarketingView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-orange-500">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] px-6 py-6 pointer-events-none">
        <div className="max-w-7xl mx-auto flex items-center justify-between pointer-events-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/login" className="bg-slate-950 text-white px-8 py-3.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-orange-600 transition-all shadow-xl active:scale-95">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 mesh-gradient overflow-hidden">
        <div ref={addToRefs} className="reveal max-w-7xl mx-auto px-6 text-center z-10">
          <div className="inline-block px-4 py-2 bg-orange-50 border border-orange-100 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-orange-600 mb-12 shadow-sm">
            Reputation Management for the 1%
          </div>
          <h1 className="text-[10vw] font-black text-slate-950 nyc-display mb-12 text-center tracking-[-0.08em] leading-[0.8]">
        ...
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 w-full max-w-7xl px-6 hidden md:flex justify-between items-end">
          <div className="text-left">
            <div className="text-6xl font-black nyc-display text-slate-950">98%</div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Open Rate</p>
          </div>
          <div className="text-right">
            <div className="text-6xl font-black nyc-display text-slate-950">5.0</div>
        ...
        <div className="marquee">
          <div className="marquee-content">
            {['MANHATTAN', 'LONDON', 'PARIS', 'TOKYO', 'DUBAI', 'BERLIN', 'SEOUL'].map(brand => (
              <span key={brand} className="text-4xl font-black tracking-[-0.05em] text-slate-100 hover:text-slate-900 transition-colors cursor-default px-16 nyc-display uppercase">{brand}</span>
            ))}
          </div>
      ...
      <section id="vision" className="dark-section py-44 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-32 items-center">
          <div ref={addToRefs} className="reveal space-y-12">
            ...
            <h2 className="text-[8vw] font-black nyc-display leading-[0.8] tracking-[-0.06em]">EQUITY <br /> IS TRUST.</h2>
      ...
      {/* SECTION: HOW (#how) */}
      <section id="how" className="py-44 bg-white relative">
        <div className="max-w-7xl mx-auto px-6">
          <div ref={addToRefs} className="reveal text-center mb-44">
            <h2 className="text-[10vw] font-black nyc-display tracking-[-0.06em] leading-none mb-12 text-slate-950">THE <br /> PROTOCOL.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-24">
            {[
              ...
              <div key={i} ref={addToRefs} className={`reveal stagger-${i + 1} group`}>
                <div className="text-[12rem] font-black text-slate-50 nyc-display mb-[-4rem] group-hover:text-orange-50 transition-colors pointer-events-none">{item.step}</div>
      ...
      <section id="platform" className="py-44 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-8">
            <div className="lg:col-span-12 mb-20">
              <h2 className="text-[8vw] font-black nyc-display leading-[0.8] tracking-[-0.05em]">THE <br /> OPERATING <br /> SYSTEM.</h2>
            </div>

            <div ref={addToRefs} className="reveal lg:col-span-7 bg-white p-16 rounded-[4rem] border border-slate-200 shadow-premium flex flex-col justify-between h-[600px]">
              <div className="w-16 h-16 bg-slate-950 text-white rounded-2xl flex items-center justify-center mb-12">
                <Icons.MessageCircle className="w-8 h-8" />
              </div>
              <div>
                <h3 className="text-5xl font-black tracking-tighter mb-8 leading-none">Meta Business <br /> Backbone.</h3>
                <p className="text-slate-500 text-xl font-medium max-w-sm">Official WhatsApp API integration ensuring 100% deliverability and verified status.</p>
              </div>
            </div>

            <div ref={addToRefs} className="reveal stagger-1 lg:col-span-5 bg-orange-600 p-16 rounded-[4rem] text-white flex flex-col justify-between h-[600px] shadow-glow">
              <h3 className="text-4xl font-black tracking-tighter mb-8 leading-tight">Privacy <br /> Intercept Gating.</h3>
      ...
      <section id="pricing" className="py-44 dark-section">
        <div className="max-w-7xl mx-auto px-6">
          <div ref={addToRefs} className="reveal text-center mb-32">
            <h2 className="text-[10vw] font-black nyc-display tracking-[-0.06em] leading-none mb-12">SCALE.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} ref={addToRefs} className={`reveal stagger-${i + 1} p-12 rounded-[4rem] border ${tier.popular ? 'bg-white text-slate-950 border-orange-500' : 'bg-white/5 text-white border-white/10'} h-[600px] flex flex-col justify-between`}>
                <div className="space-y-12">
                  ...
                  <div className="text-7xl font-black nyc-display">${tier.price}</div>
      ...
      <section className="py-64 bg-white text-center">
        <div ref={addToRefs} className="reveal max-w-7xl mx-auto px-6">
          <h2 className="text-[15vw] font-black nyc-display tracking-[-0.1em] leading-none mb-24">OWN IT.</h2>
          <Link to="/login" className="bg-orange-600 text-white px-24 py-12 rounded-[5rem] text-4xl font-black tracking-tighter hover:bg-slate-950 transition-all shadow-stripe inline-block">
            Get Started Free →
          </Link>
        </div>
      </section>
